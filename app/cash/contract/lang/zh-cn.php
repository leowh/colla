...
$lang->contract->return        = '支付';
$lang->contract->returnedBy    = '由谁支付';
$lang->contract->returnedDate  = '支付时间';
...
$lang->contract->browse           = '浏览采购';
$lang->contract->receive          = '支付';
$lang->contract->cancel           = '取消采购';
$lang->contract->view             = '采购详情';
$lang->contract->finish           = '完成采购';
$lang->contract->record           = '沟通';
$lang->contract->delete           = '删除采购';
$lang->contract->list             = '采购列表';
$lang->contract->create           = '创建采购';
$lang->contract->edit             = '编辑采购';
$lang->contract->setting          = '系统设置';
$lang->contract->uploadFile       = '上传附件';
$lang->contract->lifetime         = '采购的一生';
$lang->contract->returnRecords    = '支付记录';
$lang->contract->deliveryRecords  = '交付记录';
$lang->contract->completeReturn   = '完成支付';
$lang->contract->completeDelivery = '完成交付';
$lang->contract->editReturn       = '编辑支付';
$lang->contract->editDelivery     = '编辑交付';
$lang->contract->deleteReturn     = '删除支付';
...
$lang->contract->returnList['wait']  = '等待支付';
$lang->contract->returnList['doing'] = '部分支付';
$lang->contract->returnList['done']  = '支付完成';
...
$lang->contract->totalAmount        = '本页采购总金额：%s，已支付：%s；';
$lang->contract->returnInfo         = "<p>%s, 由 <strong>%s</strong> 支付%s。</p>";
$lang->contract->deliveryInfo       = "<p>%s由%s交付。</p>";
$lang->contract->deleteReturnInfo   = "%s的支付%s";
